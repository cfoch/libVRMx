...
main (int argc, char **argv)
{
  ...
  ctx.settings.lighting.positions[2] = glm::vec3(-3.0,-3.0, 3.0);
  ctx.settings.lighting.positions[3] = glm::vec3( 3.0,-3.0, 3.0);
  ctx.settings.lighting.colors[0] = glm::vec3(30, 30, 30);
  ctx.settings.lighting.colors[1] = glm::vec3(30, 30, 30);
  ...
  ctx.settings.ignoreNormals = false;

  static GOptionEntry option_entries[] = {
    { "ignore-normals", 0, 0, G_OPTION_ARG_NONE, &ctx.settings.ignoreNormals,
      "Ignore normals in the VRM input file", NULL },
    { NULL }
  };
